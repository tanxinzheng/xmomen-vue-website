    ...
    <v-layout>
      <v-flex sm4>
        <v-card class="mo-card-height-md">
          <v-toolbar color="light-blue" dark height="48">
          ...
          <v-list two-line subheader>
            ...
            <v-list-tile avatar v-bind:key="item.groupName" @click="choseGroup(item)" height="50" v-bind:class="{'mo-card-selection': item.id == currentGroup.id}" >
              ...
              <v-list-tile-action>
                <v-list-tile-action-text>{{ item.groupType }} － 用户组类型</v-list-tile-action-text>
        ...
        <v-card class="mo-card-height-md">
          ...
          <v-list two-line subheader>
            ...
            <v-list-tile avatar v-bind:key="user.id">
              <v-list-tile-avatar>
                <mo-avatar size="26px" :avatarModel="user" avatarTextKey="nickname"></mo-avatar>
              </v-list-tile-avatar>
              <v-list-tile-content>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url:"/group",
        formColumns: [
          {name: 'groupType', label: '用户组类型', type: 'text'},
          {name: 'groupCode', label: '用户组代码', type: 'text'},
