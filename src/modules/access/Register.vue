      ...
      <v-tabs fixed centered v-model="currentTab">
        <v-toolbar color="primary" dark>
          <v-tabs-bar color="transparent" dark>
            ...
            <v-tabs-item :href="'#tab-register'" @click="switchType(1)">手机注册</v-tabs-item>
            <v-tabs-item :href="'#tab-register'" @click="switchType(2)">邮箱注册</v-tabs-item>
          </v-tabs-bar>
        </v-toolbar>
        <v-tabs-items>
            ...
            <v-card>
              <v-card-text>
                <v-form v-model="registerValid" ref="registerForm" lazy-validation>
                  ...
                  <v-btn color="primary" :loading="registerLoading" @click="doRegister()"  :disabled="!registerValid">注册</v-btn>
